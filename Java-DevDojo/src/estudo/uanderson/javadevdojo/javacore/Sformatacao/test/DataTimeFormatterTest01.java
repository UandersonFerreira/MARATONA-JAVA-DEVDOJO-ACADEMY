...
public class DataTimeFormatterTest01 {
    public static void main(String[] args) {
       ...
       System.out.println(parse4);
        ...
        //MM/dd/yyyy USA
        //yyyy/MM/dd  Japão
        DateTimeFormatter formatterBR = DateTimeFormatter.ofPattern("dd MMMM 'de' yyyy");
        String  formatBR = LocalDate.now().format(formatterBR);
        System.out.println(formatBR);

        LocalDate parseBR = LocalDate.parse("10 julho de 2021", formatterBR);//o formato da data têm que seguir o definido em FormatterBR, se não dar erro.
